...
<div class="container-fluid">
    <div class="row">
        <div class="col-12 col-md-8">
            <h3>Toutes les réglementations aérotiques de l'Autorité de l'Aviation Civile de Djibouti</h3>
...
export default {
  metaInfo() {
    return {
      title: "Reglementations aérotiques",
      meta: [
        {
          vmid: "description",
          name: "description",
          content:
            "Toutes les réglementations aérotiques de l'autorité de l'aviation civile de djibouti",
        },
      ],
    };
  },

    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-12 col-md-8">
          <p>
            n, air traffic control and safety, ensuring international standards
            of air navigation equipment and controlling airports service
            delivery as well as putting in place principles and standards of the
            International Civil Aviation Organization (ICAO). The Ethiopian
            Civil Aviation Authority Regulatory Division has also been showing
            commendable progress in updating its status approved by the US
            Federal Aviation Administration (AFA) and ICAO USOAP Audit while
            implementing Quality Management System (ISO 9001/2015) and capacity
            building program. The Ethiopian Government sees the aviation sector
            as integral to securing that future growth of this country, the
            Eastern Africa region and Africa in general. Our airports, airlines
            and associate industries facilitate to generate the required
            financial resource. Currently ECAA is revamping its training center,
            ECATA, which has recent
          </p>
        </div>
      </div>
    </div>
